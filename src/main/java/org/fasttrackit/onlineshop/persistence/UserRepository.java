...
public interface UserRepository extends JpaRepository<User,Long> {
    ...
    Page<User> findByFristNameAndLastNameContains(String partialFirstName,String partialLastname, Pageable pageable);

      @Query( value = "SELECT  user  FROM User user" +
               " WHERE(:partialFirstName IS NULL OR user.fristName LIKE %:partialFirstName%)"
